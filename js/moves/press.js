...
h0: { label: 'In front', legs: STANCE, arms: { L: { hand: [0.05, 1.36, 0.25], elbow: [-0.081, -0.238, 0.164] }, R: { hand: [-0.05, 1.36, 0.25], elbow: [-0.095, -0.123, 0.257] } } },
      h30: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.085, 1.431, 0.247], elbow: [-0.071, -0.105, 0.272] }, R: { hand: [-0.172, 1.431, 0.197], elbow: [-0.2, -0.083, 0.207] } } },
      h60: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.2, 1.482, 0.173], elbow: [-0.14, 0.059, 0.259] }, R: { hand: [-0.25, 1.482, 0.087], elbow: [-0.231, -0.083, 0.173] } } },
      h90: { label: 'Right side', legs: STANCE, arms: { L: { hand: [-0.26, 1.5, 0.05], elbow: [-0.243, -0.003, 0.176] }, R: { hand: [-0.26, 1.5, -0.05], elbow: [-0.267, 0.039, 0.131] } } },
      h120: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.253, 1.483, -0.089], elbow: [-0.217, 0.1, -0.181] }, R: { hand: [-0.203, 1.483, -0.175], elbow: [-0.064, 0.291, 0.038] } } },
      h150: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.182, 1.439, -0.216], elbow: [-0.139, -0.011, -0.266] }, R: { hand: [-0.096, 1.439, -0.266], elbow: [0.086, -0.195, -0.211] } } },
      h180: { label: 'Behind', legs: STANCE, arms: { L: { hand: [-0.05, 1.38, -0.3], elbow: [-0.005, -0.104, -0.281] }, R: { hand: [0.05, 1.38, -0.3], elbow: [0.063, -0.182, -0.23] } } },
      h210: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.096, 1.439, -0.266], elbow: [-0.026, -0.187, -0.233] }, R: { hand: [0.182, 1.439, -0.216], elbow: [0.139, -0.011, -0.266] } } },
      h240: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.203, 1.483, -0.175], elbow: [-0.004, 0.298, 0.037] }, R: { hand: [0.253, 1.483, -0.089], elbow: [0.236, 0.02, -0.184] } } },
      h270: { label: 'Left side', legs: STANCE, arms: { L: { hand: [0.26, 1.5, -0.05], elbow: [0.291, 0.018, 0.071] }, R: { hand: [0.26, 1.5, 0.05], elbow: [0.22, 0.069, 0.192] } } },
      h300: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.25, 1.482, 0.087], elbow: [-0.002, -0.083, 0.288] }, R: { hand: [0.2, 1.482, 0.173], elbow: [0.14, 0.059, 0.259] } } },
      h330: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.172, 1.431, 0.197], elbow: [-0.082, -0.196, 0.212] }, R: { hand: [0.085, 1.431, 0.247], elbow: [0.071, -0.105, 0.272] } } },
    },
