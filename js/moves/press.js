...
h0: { label: 'In front', legs: STANCE, arms: { L: { hand: [0.05, 1.36, 0.25], elbow: [-0.028, -0.23, 0.191] }, R: { hand: [-0.05, 1.36, 0.25], elbow: [0.028, -0.23, 0.191] } } },
      h30: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.083, 1.482, 0.244], elbow: [-0.142, -0.113, 0.239] }, R: { hand: [-0.17, 1.482, 0.194], elbow: [0.023, -0.151, 0.258] } } },
      h60: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.202, 1.57, 0.175], elbow: [-0.189, 0.034, 0.23] }, R: { hand: [-0.252, 1.57, 0.088], elbow: [-0.075, -0.004, 0.29] } } },
      h90: { label: 'Right side', legs: STANCE, arms: { L: { hand: [-0.275, 1.6, 0.05], elbow: [-0.237, 0.114, 0.144] }, R: { hand: [-0.275, 1.6, -0.05], elbow: [-0.16, 0.133, 0.216] } } },
      h120: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.274, 1.574, -0.1], elbow: [-0.264, 0.117, 0.08] }, R: { hand: [-0.224, 1.574, -0.187], elbow: [-0.163, 0.242, 0.069] } } },
      h150: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.192, 1.508, -0.232], elbow: [-0.269, 0.128, 0.037] }, R: { hand: [-0.105, 1.508, -0.282], elbow: [-0.073, 0.275, -0.096] } } },
      h180: { label: 'Behind', legs: STANCE, arms: { L: { hand: [-0.05, 1.42, -0.3], elbow: [-0.07, 0.225, -0.186] }, R: { hand: [0.05, 1.42, -0.3], elbow: [0.07, 0.225, -0.186] } } },
      h210: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.105, 1.508, -0.282], elbow: [0.001, 0.294, -0.061] }, R: { hand: [0.192, 1.508, -0.232], elbow: [0.269, 0.128, 0.037] } } },
      h240: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.224, 1.574, -0.187], elbow: [0.023, 0.284, 0.093] }, R: { hand: [0.274, 1.574, -0.1], elbow: [0.264, 0.117, 0.08] } } },
      h270: { label: 'Left side', legs: STANCE, arms: { L: { hand: [0.275, 1.6, -0.05], elbow: [0.062, 0.171, 0.238] }, R: { hand: [0.275, 1.6, 0.05], elbow: [0.237, 0.114, 0.144] } } },
      h300: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.252, 1.57, 0.088], elbow: [0.136, -0.008, 0.267] }, R: { hand: [0.202, 1.57, 0.175], elbow: [0.145, 0.118, 0.235] } } },
      h330: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.17, 1.482, 0.194], elbow: [0.169, -0.072, 0.237] }, R: { hand: [0.083, 1.482, 0.244], elbow: [0.046, -0.018, 0.296] } } },
    },
