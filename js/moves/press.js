...
h0: { label: 'In front', legs: STANCE, arms: { L: { hand: [0.05, 1.36, 0.25], elbow: [-0.081, -0.238, 0.164] }, R: { hand: [-0.05, 1.36, 0.25], elbow: [-0.095, -0.123, 0.257] } } },
      h30: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.084, 1.433, 0.245], elbow: [-0.071, -0.105, 0.272] }, R: { hand: [-0.17, 1.433, 0.195], elbow: [-0.199, -0.081, 0.209] } } },
      h60: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.198, 1.484, 0.172], elbow: [-0.131, 0.14, 0.231] }, R: { hand: [-0.248, 1.484, 0.086], elbow: [-0.229, -0.078, 0.177] } } },
      h90: { label: 'Right side', legs: STANCE, arms: { L: { hand: [-0.26, 1.5, 0.05], elbow: [-0.277, -0.069, 0.091] }, R: { hand: [-0.26, 1.5, -0.05], elbow: [-0.291, 0.018, 0.071] } } },
      h120: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.246, 1.49, -0.085], elbow: [-0.286, -0.089, 0.01] }, R: { hand: [-0.196, 1.49, -0.171], elbow: [-0.183, 0.238, 0.011] } } },
      h150: { label: 'Round', legs: STANCE, arms: { L: { hand: [-0.164, 1.472, -0.184], elbow: [-0.279, -0.11, -0.01] }, R: { hand: [-0.077, 1.472, -0.234], elbow: [0.226, -0.131, -0.147] } } },
      h180: { label: 'Behind', legs: STANCE, arms: { L: { hand: [-0.05, 1.45, -0.22], elbow: [-0.154, -0.17, -0.194] }, R: { hand: [0.05, 1.45, -0.22], elbow: [0.256, -0.148, -0.052] } } },
      h210: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.077, 1.472, -0.234], elbow: [-0.029, 0.294, -0.051] }, R: { hand: [0.164, 1.472, -0.184], elbow: [0.279, -0.11, -0.01] } } },
      h240: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.196, 1.49, -0.171], elbow: [0.183, 0.238, 0.011] }, R: { hand: [0.246, 1.49, -0.085], elbow: [0.286, -0.089, 0.01] } } },
      h270: { label: 'Left side', legs: STANCE, arms: { L: { hand: [0.26, 1.5, -0.05], elbow: [0.291, 0.018, 0.071] }, R: { hand: [0.26, 1.5, 0.05], elbow: [0.277, -0.069, 0.091] } } },
      h300: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.248, 1.484, 0.086], elbow: [-0.004, -0.078, 0.29] }, R: { hand: [0.198, 1.484, 0.172], elbow: [0.131, 0.14, 0.231] } } },
      h330: { label: 'Round', legs: STANCE, arms: { L: { hand: [0.17, 1.433, 0.195], elbow: [-0.083, -0.194, 0.214] }, R: { hand: [0.084, 1.433, 0.245], elbow: [0.071, -0.105, 0.272] } } },
    },
