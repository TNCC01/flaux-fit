...
- Two-frame stick-figure demos on the workout screen for every exercise
  (toggleable), drawn in the app's own style. Generated by
  `scripts/gen-anims.py` into `img/exercises/<base>-{0,1}.svg` — edit the
  pose data and re-run to tweak
